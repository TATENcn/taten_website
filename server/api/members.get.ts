  ...
  return [
    {
      ...
      introduction:
        "你好，我是 Bcamy，一名来自山东的初中生，团队的发起者兼组织者。我热爱计算机科学与编程，喜欢研究系统底层与技术原理。熟悉 Python 与 C/C++，正在阅读《深入理解计算机系统》《现代操作系统》等书籍，并学习 408 考研相关内容。我曾学习过 OI，也在不断探索数据结构与算法。动手搭建系统、理解原理，是我最享受的过程。另外，我还是新人 UP 主，UID：2126856300，我使用 Ae、DaVinci、Pr、Blender 制作视频。现在，我希望聚集更多热爱技术的中学生，一起学习、创造、交流，共同成长。",
    ...
    },
    {
      ...
      introduction:
        "目前小学6年级 男生 热爱编程 熟练的语言是 Python PHP JavaScript前端开发 生日：七月五日 喜欢的动漫是：别当欧尼酱了! 热爱的游戏 CS GO 原神 绝区零 和部分手游等",
    ...
    },
    {
      ...
      introduction:
        "Hi，我是 errorsia，一枚菜鸟，正在努力的学习英语中。目前正在使用 Python 开发，正在学习 JavaScript，C++。热爱折腾各种技术和数码产品，在探索中不断成长。",
    ...
    */
    ...
    {
      avatarUrl: "https://avatars.githubusercontent.com/u/196782409?v=4",
      name: "GuYang17",
      skills: ["Python", "C#", "C++", "C", "Web前端等"],
      introduction:
